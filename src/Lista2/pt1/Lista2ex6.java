...
public class Lista2ex6 {
     public static void main(String[] args) {
        ...
        if ((numero1 % 2 == 0) && (numero1 % 3 == 0)) {
            System.out.print(numero1 + " é divisivel por 2 e 3");
        }
        if ((numero2 % 2 == 0) && (numero2 % 3 == 0)) {
            System.out.print(numero2 + " é divisivel por 2 e 3");
        }
        if ((numero3 % 2 == 0) && (numero3 % 3 == 0)) {
            System.out.print(numero3 + " é divisivel por 2 e 3");
        }
        if ((numero4 % 2 == 0) && (numero4 % 3 == 0)) {
            System.out.print(numero4 + " é divisivel por 2 e 3");
        } else {
